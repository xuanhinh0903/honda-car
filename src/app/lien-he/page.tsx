...
const contactInfo = [
  ...
  },
  {
    icon: Clock,
    label: "Giờ làm việc",
    value: "Thứ 2 - Chủ nhật: 8:00 - 18:00",
  },
];
  ...
  return (
    <div className="pt-24 pb-16">
      <div className="container mx-auto px-4">
        <SectionTitle subtitle="Liên hệ" title="Kết nối với chúng tôi" />
          ...
          <FadeIn>
            <div className="space-y-6">
              ...
              <div className="mt-8 rounded-2xl overflow-hidden border border-border/50 aspect-video bg-muted">
                <iframe
                  src="https://maps.google.com/maps?q=Honda+An+Khanh+Hanoi&output=embed"
